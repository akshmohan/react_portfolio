...
export const HERO_CONTENT = `I am a passionate Mobile Developer with a knack for crafting robust and scalable mobile and web applications. With 2 years of hands-on experience, I have honed my skills in front-end technologies like Flutter and React, as well as back-end technologies like Node.js, PostgreSQL, and MongoDB. My goal is to leverage my expertise to create innovative solutions that drive business growth and deliver exceptional user experiences.`;

export const ABOUT_TEXT = `I am a dedicated and versatile Mobile App Developer with a passion for creating efficient and user-friendly mobile applications. With 2 years of professional experience, I have worked with a variety of technologies, including Flutter, React, Node.js, PostgreSQL, and MongoDB. My journey in software development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, solving DSA problems and learning about System Design.`;
...
export const CONTACT = {
  phoneNo: "+91 70122 98254",
  email: "akshaymohan.career@gmail.com",
};
